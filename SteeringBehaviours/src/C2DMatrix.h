...
public:
  ...
  inline void  Rotate(const sf::Vector2f &fwd, const sf::Vector2f &side);

   //applys a transformation matrix to a std::vector of points
  inline void TransformVector2D(std::vector<sf::Vector2f> &vPoints);

  //applys a transformation matrix to a point
  inline void TransformVector2D(sf::Vector2f &vPoint);
...
//applies a 2D transformation matrix to a std::vector of sf::Vector2fs
inline void C2DMatrix::TransformVector2D(std::vector<sf::Vector2f> &vPoint)
{
...
//applies a 2D transformation matrix to a single sf::Vector2f
inline void C2DMatrix::TransformVector2D(sf::Vector2f &vPoint)
{
...
inline void C2DMatrix::Rotate(const sf::Vector2f &fwd, const sf::Vector2f &side)
{
  C2DMatrix::Matrix mat;
