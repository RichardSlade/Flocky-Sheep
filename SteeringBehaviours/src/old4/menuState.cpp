...
, mEnterName(false)
{
    ...
    mTitleText.setPosition(mViewCenter.x, mViewCenter.y - 128);
...
//    mMenuText.at(0).setFont(mController.getFont(Controller::Fonts::Sheepy));
...
int MenuState::getMaxMenuSelection(MenuType menuType)
{
    switch(menuType)
    {
        case MenuState::MenuType::Main: return 3;
    ...
    switch(mCurrentMenu)
    {
        case MenuState::MenuType::Main:
        {
            switch(menuSelection)
            {
                ...
                case 2: return MenuState::MenuType::Quit;
